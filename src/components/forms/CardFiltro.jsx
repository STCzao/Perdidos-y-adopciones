...
const CardFiltro = ({ filtros, setFiltros, tipo, razasPorEspecie = {} }) => {
  ...
  return (
    <div className="w-full max-w-xs bg-white/90 border border-[#FF7857]/20 rounded-2xl shadow-md p-4 text-black font-medium flex flex-col gap-3">
      <button
        type="button"
        className="flex items-center justify-between w-full text-sm font-semibold text-black uppercase mb-1 cursor-pointer"
      ...
      >
        ...
        <button
          ...
          className="w-full px-3 py-2 rounded-full text-xs font-semibold bg-red-500/10 text-red-600 border border-red-500/30 hover:bg-red-500/20 transition-colors delay-100 duration-300 cursor-pointer"
        >
          Limpiar filtros
        </button>
      </div>
