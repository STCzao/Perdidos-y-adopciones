...
const ContactScreen = () => {
  ...
  return (
    <div className="bg-[#f6efe4] text-[#241914]">
      ...
      <section
        className="relative isolate overflow-hidden px-4 pb-16 pt-32 sm:px-6 lg:px-8"
        style={{
          background:
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="grid gap-8 lg:grid-cols-[0.82fr_1.18fr]">
            <motion.div
              ...
              className="rounded-[2rem] border border-white/10 bg-[rgba(22,17,15,0.52)] p-6 text-white shadow-[0_24px_70px_rgba(0,0,0,0.22)] backdrop-blur-sm lg:p-8"
            >
              ...
              <h1 className="font-editorial mt-5 text-[2.6rem] leading-[0.92] text-white sm:text-[3rem]">
                Formulario para colaboradores.
              </h1>
              <p className="mt-4 max-w-xl text-[0.98rem] leading-relaxed text-white/82">
                Si quieres sumarte a esta iniciativa, aquí puedes contarnos cómo te
                gustaría ayudar.
              </p>
              <p className="mt-3 max-w-xl text-[0.92rem] leading-relaxed text-white/68">
            ...
            <motion.div
              ...
              className="rounded-[2rem] border border-white/10 bg-[rgba(255,250,244,0.94)] p-5 shadow-[0_24px_70px_rgba(0,0,0,0.18)] lg:p-6"
            >
