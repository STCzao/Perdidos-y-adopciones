            ...
            {config.cards.map((card) => (
              card.id === "advice" ? (
                <button
                  ...
                  className="text-red-600 font-medium hover:underline transition-all duration-300 cursor-pointer"
                >
                  {card.buttonText}
                </button>
              ) : (
                <button
                  onClick={() => handleAction(card.action)}
                  className={`text-white border border-white/40 font-medium w-50 h-11 rounded-full bg-white/60 hover:bg-[#FF7857] transition-colors delay-100 duration-300 cursor-pointer ${
